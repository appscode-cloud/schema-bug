module github.com/tamalsaha/schema-bug
...
require (
	...
	kmodules.xyz/resource-metadata v0.18.11-0.20240802101818-9d80d06c5f42 // indirect
...
replace (
	go.etcd.io/etcd/api/v3 => go.etcd.io/etcd/api/v3 v3.5.14
	go.etcd.io/etcd/client/pkg/v3 => go.etcd.io/etcd/client/pkg/v3 v3.5.14
)
...
replace (
	...
	github.com/go-macaron/csrf => github.com/wandrs/csrf v0.0.0-20240215050249-45fd0d5fe54a
	github.com/go-macaron/session => github.com/wandrs/macaron-session v0.0.0-20240528164243-dc5da78c19c6
	github.com/imdario/mergo => github.com/imdario/mergo v0.3.6
	github.com/mileusna/useragent => github.com/wandrs/useragent v0.0.0-20230916115129-ab1411d0ebd8
	github.com/trickstercache/trickster/v2 => github.com/open-viz/trickster/v2 v2.0.0-beta3.0.20240105204057-647786143c86
	helm.sh/helm/v3 => github.com/x-helm/helm/v3 v3.15.1-0.20240519042544-f489f30bb34d
	k8s.io/apiserver => github.com/kmodules/apiserver v0.30.2-0.20240519082755-d7b8c2d9e699
	sigs.k8s.io/controller-runtime => github.com/kmodules/controller-runtime v0.18.4-0.20240603164526-fa88ec2314fe
)
